...
text(50, 207, "콤마나인 × 배달의민족 광고 영업 — Win-Win 파트너십",
...
# ============================================================
# 4. 해결책: 콤마나인 = 시발점 접점 (170 ~ 145)
# ============================================================
text(50, 170, "■ 콤마나인은 점주를 가장 먼저 만납니다",
     size=14, color=COLOR_DARK, weight='bold')
...
text(17.5, 163, "콤마나인 진입 ✓", size=10, color='white', weight='bold')
...
text(50, 150.5,
     "콤마나인과 협업하면 = 점주가 가게를 만드는 단계에서 당신과 연결됩니다",
...
text(50, 4, "콤마나인 / 디엘나인  |  배민 광고 영업자 협업 제안서  |  내부 교육용",
     size=8.5, color='#9CA3AF')
text(50, 1.7,
     "문의: 콤마나인 사업기획팀  |  영천 사옥 투어 상시 가능",
